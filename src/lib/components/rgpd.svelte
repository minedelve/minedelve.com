<script lang="ts">
	...
	import { getCookie, setCookie } from '$lib/assets/utils';
	import { eventNoScroll } from '$lib/assets/utils/noScroll';
...
<dialog bind:this={dialog}>
	...
	<div class="dialog-container">
		<div class="card">
			...
			<p>
				Minedelve and our partners use cookies or similar technologies to enable us to improve the
				site, your experience and to ensure the proper functioning of the site, to collect
				statistics in order to optimize the services offered, and to adapt Minedelve's content.
			</p>
			<div>
